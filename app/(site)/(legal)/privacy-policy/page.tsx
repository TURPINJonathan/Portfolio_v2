    ...
    <>
      <section className="container section flex flex-col gap-4">
        ...
        <section className="cardContainer" aria-labelledby="security">
          ...
          <p className="mt-2">
            <strong>{LEGAL.publisherName}</strong> met en œuvre des mesures techniques et organisationnelles
            raisonnables pour protéger les données personnelles contre la perte, l’altération, l’accès non autorisé ou
            la divulgation.
          </p>
        </section>
